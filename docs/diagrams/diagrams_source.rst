...
http://www.nomnoml.com/ https://bramp.github.io/js-sequence-diagrams/
...
-  m2mclient = DefaultHTTPClient(client, api\_endpoint, api\_port)
-  eth\_ticker

Server
~~~~~~

-  app = PaywalledProxy(CHANNEL\_MANAGER\_ADDRESS, private\_key,
   tempfile)
-  custom proxy
