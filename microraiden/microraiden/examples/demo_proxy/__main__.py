...
def start(app, host, port):
    ...
    app.add_content(PaywalledContent("doggo", 2 * TKN, get_doggo))
    app.add_content(PaywalledFortune("wisdom", 1 * TKN, fortunes_path))
    app.add_content(PaywalledContent("teapot", 3 * TKN, lambda _: ("HI I AM A TEAPOT", 418)))
